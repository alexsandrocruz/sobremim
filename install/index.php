...
if (isset($_POST["btn_purchase_code"])) {
    ...
    $url = "http://script.macrotechbd.com/api/license?purchase_code=" . $_POST['purchase_code'] . "&domain=" . $current_url;
...
<head>
    ...
    <title>Profile.me - Installer</title>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab_1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="purchase_code" class="form-control form-input" style="resize: vertical; height: 80px;line-height: 24px;padding: 10px;" placeholder="Enter 'raz0r' right here!" required></textarea>
                                            </div>
                                            ...
                                            <div class="form-group text-left">
                                                <p><a style="color:red;" href="https://daviruzsystems.com" target="_blank">Da-viruz Systems</a></p>
                                            </div>
