        ...
        <div class="col-md-12">
            ...
            <div class="pay-box">
                ...
                <?php if (isset($success_msg) && $success_msg=='Success'): ?>
                    <h3 class="success"><i class="icon-check"></i> Concluído</h3>
                    <h5 class="success">Seu pagamento foi concluído com sucesso !</h5><br>
                ...
                <?php elseif (isset($error_msg) && $error_msg=='Error'): ?>
                    ...
                    <h5 class="error">O pagamento falhou</h5><br>
                    <a href="<?php echo base_url() ?>" class="btn btn-md btn-danger">Voltar para a Home</a>
                <?php else: ?>

                    <h2><strong>Pagamento do Paypal</strong></h2><br>
                    ...
                    <form action="<?php echo html_escape($paypal_url); ?>" method="post" name="frmPayPal1">
                        <div class="panel price panel-red">
                            ...
                            <div class="panel-body text-center">
                                <p class="lead" style="font-size:40px"><strong>$<?php echo round($package->price);?> / ano</strong></p>
                            </div>
                            <div class="panel-footer">
                                <button class="btn btn-lg btn-block btn-info" href="#">PAGAR AGORA!</button>
                            </div>
                        </div>
                    </form>
                    <!-- /PRICE ITEM -->
