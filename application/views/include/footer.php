                ...
                <div class="row start-height">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-3 xs-full">
                        ...
                        <ul class="footer-list">
                            <li><a href="<?php echo base_url('features') ?>">Recursos</a></li>
                            <li><a href="<?php echo base_url('pricing') ?>">Preços</a></li>
                            <li><a href="<?php echo base_url('create-profile') ?>">Crie a sua página</a></li>
                        </ul>
