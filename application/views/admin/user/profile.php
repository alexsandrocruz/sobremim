      ...
      <div class="col-xl-3 col-lg-3">
        ...
        <div class="box">
          <div class="box-body box-profile">
            ...
            <h5 class="text-center"><?php echo $user->name ?> <?php if($user->hit != 0){echo "- Profile views (".$user->hit.')';} ?></h5>

            <h5 class="text-center">Joined: <?php echo get_time_ago($user->created_at); ?></h5>
            <h5 class="text-center text-danger"><b><?php echo date_difference($user->created_at); ?> days left</b></h5>
        ...
        <form method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/profile/update') ?>" role="form" class="form-horizontal">
          ...
          <div class="nav-tabs-custom">
              <ul class="nav nav-tabs">
                  ...
                  <!-- <li><a href="#content3" data-toggle="tab"><i class="fa fa-usd"></i> Online Marketplace</a></li> -->
                  <?php endif ?>
