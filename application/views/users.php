<section class="section-padding">
    <div class="container">
        <div class="row mb-20">
            ...
            <div class="col-md-3 col-xs-4">
                <div class="pull-right">
                  ...
                  <select class="form-control sort_user" id="sel1">
                      <option value="<?php echo base_url('home/users?sort=all') ?>">Escolher habilidades</option>
            ...
            <div class="col-md-3 col-xs-4">
                <div class="pull-right">
                  <label for="sel1">Organizar usuários</label>
                  <select class="form-control sort_user" id="sel1">
                         ...
                         <div class="card-container manual-flip">
                            <div class="card">
                                <div class="front">
                                    ...
                                    <a target="_blank" href="<?php echo base_url('profile/'.$user->slug) ?>">
                                        <div class="user">
                                            ...
                                            <?php if ($this->session->userdata('logged_in') == TRUE): ?>
                                                <?php $follow = check_follower($user->id); ?>
                                                    <div class="card-btns text-center">
                                                        <?php if ($follow == 0): ?>
                                                            <a href="#" id="follow_<?php echo $user->id; ?>" data-id="<?php echo $user->id; ?>" class="btn follow mr-5"><i class="fa fa-user-plus"></i> Seguir</a>
                                                        <?php else: ?>
                                                            <a href="#" id="unfollow_<?php echo $user->id; ?>" data-id="<?php echo $user->id; ?>" class="btn unfollow mr-5"><i class="fa fa-check"></i> Seguindo</a>
                                                        <?php endif ?>
                                                        <a target="_blank" href="<?php echo base_url('profile/'.$user->slug) ?>" class="btn default"><i class="fa fa-eye"></i> Visualizar Perfil</a>
                                                    </div>
                                                <?php else: ?>
                                                    <div class="card-btns text-center">
                                                        <a href="<?php echo base_url('login') ?>" class="btn default mr-5"><i class="fa fa-user-plus"></i> Seguir</a>
